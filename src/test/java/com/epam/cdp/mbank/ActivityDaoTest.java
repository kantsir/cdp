...
public class ActivityDaoTest extends UnitilsJUnit4 {
	...
	public void getAll() {
		...
		ReflectionAssert.assertPropertyLenientEquals("amount", Arrays.asList(1.0,2.0,3.0), actualObjects);
	...
	//<activities amount="4.0" commision="4.0" description="descroption4"
	//		activity_date="2012-04-14 14:14:14" />
